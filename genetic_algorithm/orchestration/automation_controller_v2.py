...
def default_automation_policy(
    ...
    *,
    ...
    return AutomationPolicyV2(
        ...
        selection_policy=CandidateSelectionPolicyV2(
            selection_policy_version="guarded-island-pareto-v2.2-balanced-continuation",
            max_selected=1,
            min_selected=1,
        ...
        planner_policy=WavePlannerPolicyV2(
            planner_policy_version="guarded-island-next-wave-v2.4-balanced-replication",
            child_result_policy_version=result_policy,
            child_search_space_version="automation-island-v2.2",
            ...
            arm_templates=[
                ...
                WaveArmTemplateV2(
                    ...
                    factor_delta={
                        ...
                        "fitness_weights.trade_frequency": 0.10,
                ...
                WaveArmTemplateV2(
                    ...
                    factor_delta={
                        ...
                        "fitness_weights.drawdown_duration": 0.14,
                        "fitness_weights.profit": 0.28,
                        "genetic_algorithm.mutation_rate": 0.35,
                ...
                WaveArmTemplateV2(
                    ...
                    factor_delta={
                        "fitness_weights.drawdown_duration": 0.08,
                        "fitness_weights.profit": 0.36,
                        "fitness_weights.profit_factor": 0.22,
